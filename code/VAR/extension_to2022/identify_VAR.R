...
maxiter = 10^6 ## then give update on progress
...
saveRDS(successes, file = "./data/VAR_data/extension_to2022/successful_rotations.RDS")
saveRDS(success_seeds, file = "./data/VAR_data/extension_to2022/success_seeds.RDS")
...
), file = "./data/VAR_data/extension_to2022/estimated_VAR.RDS")
