...
myvar <- readRDS("./data/VAR_data/extension_to2022/estimated_VAR.RDS")
...
saveRDS(list(rots_l = rots_data_l, MT_i = i_min), "./data/VAR_data/extension_to2022/rotations_long_MT.RDS")
saveRDS(omegas_summ, "./data/VAR_data/extension_to2022/structural_shock_summaries.RDS")
