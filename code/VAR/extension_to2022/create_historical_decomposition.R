...
myvar <- readRDS("./data/VAR_data/extension_to2022/reduced_form_VAR.RDS")
rots <- readRDS("./data/VAR_data/extension_to2022/successful_rotations.RDS")
rots_dt <- readRDS("./data/VAR_data/extension_to2022/rotations_long_MT.RDS")
omega_summ <- readRDS("./data/VAR_data/extension_to2022/structural_shock_summaries.RDS")
...
## Save HD to disk
saveRDS(hd_data, "./data/VAR_data/extension_to2022/HistoricalDecomposition_data.RDS")
