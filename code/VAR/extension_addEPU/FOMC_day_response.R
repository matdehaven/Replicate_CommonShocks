...
hd_data <- readRDS("./data/VAR_data/extension_addEPU/HistoricalDecomposition_data.RDS")
...
##
vars <- c("sp", "yc2", "yc5", "yc10", "epu")
ss <- c("Overall", "g", "m", "pp", "pm", "rp", "epu")
reg_result <-
...
reg_result[beta == "V1"] |>
  ...
  scale_x_discrete(limits = c("Overall","g", "m", "pp", "pm", "rp", "epu"), )
